...
|---|---|---|---|---|---|---|---|
| 1 | Representation | **9/10** | strict_causal_edge_ratio | 0.3299 | 0.3 | ✓ | STRICT causal: 223/676 (33.0%). Broad (incl. depends_on/analogous_to): 233/676 (34.5%). Scored on st |
...
| 6 | Causal reasoning | **9/10** | data_estimated | 13 | data-estimated do(X) at p<0.05 | ✓ | Data-estimated (not hardcoded). 13 observations. Sufficient data. |
...
| 11 | Scalability | **9/10** | real_graph_search_time | 0.7847 | sub-second on real graph | ✓ | Real graph (3301 nodes): search=0.7847s. Sub-second: True. |
