...
**Generated:** 2026-08-06 19:08 UTC
...
|---|---|---|---|---|---|---|---|
| 1 | Representation | **9/10** | causal_edge_ratio | 0.322 | 0.3 | ✓ | 209/649 edges are causal (32.2%). Target: >30%. |
...
| 6 | Causal reasoning | **9/10** | data_estimated | 7 | data-estimated do(X) at p<0.05 | ✓ | Data-estimated (not hardcoded). 7 observations. Sufficient data. |
...
| 11 | Scalability | **9/10** | real_graph_search_time | 0.4611 | sub-second on real graph | ✓ | Real graph (1705 nodes): search=0.4611s. Sub-second: True. |
