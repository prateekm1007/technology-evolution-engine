...
**Generated:** 2026-08-06 19:58 UTC
...
| 2 | Mechanism extraction | **9/10** | F1 + NLP-first | 0.9091 | 0.9 | ✓ | Gen 4 F1=0.9091. NLP-first extraction: True. Target: F1≥0.90. |
...
| 7 | Structural analogy | **9/10** | sub_graph_isomorphism | 3 | isomorphic subgraphs with structural topology matching | ✓ | 3 isomorphic analogies found. Top score: 1.0. VF2-inspired (not string sequences). |
...
| 9 | Experiment design | **9/10** | edge_updated + grounded_hyp | 1 | ≥1 measured result auto-updates edge tier + template-free hypotheses | ✓ | Edge tier updated: ASSERTED → VERIFIED. Grounded v2 (template-free): True. |
...
| 11 | Scalability | **9/10** | real_graph_search_time | 0.7949 | sub-second on real graph | ✓ | Real graph (3301 nodes): search=0.7949s. Sub-second: True. |
