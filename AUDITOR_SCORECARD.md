...
**Generated:** 2026-08-07 23:58 UTC
...
| Discovery Capability (operator-blind) | **6/10** | F1 | 0.5714 | `benchmarks/reports/discovery_capability_score.json` | `tests/test_failure_regression_suite.py` | Operator-blind gold-standard discovery |
