...
| Gen 3: Relation Extraction | **7/10** | F1 | 0.6548 | `benchmarks/reports/gen3_pr_score.json` | `tests/test_regression_suite.py` | BOTTLENECK — auditor's #1 target for F1≥0.90 |
