...
| M-004 | Synonym F1 (all entities) | 0.3053 | False | NOT_TESTED | 0 |
...
| M-014 | BM25 recall@1 (lenient) | 0.6500 | False | NOT_TESTED | 0 |
| M-015 | Random baseline F1 (lenient) | 0.1000 | False | NOT_TESTED | 0 |
| M-016 | Frequency baseline F1 (lenient) | 0.3000 | False | NOT_TESTED | 0 |
...
- **M-006** (Recognition F1 (all, syn, DR-91)): baseline = 1.0000 (no variance)
