...
GOLD_DISCOVERIES = [
    {
        ...
        "source_snippet_a": "Fungi can precipitate calcium carbonate through biomineralization processes, forming stable mineral structures.",
        "source_snippet_b": "Calcium carbonate materials with controlled morphology can be synthesized through biological pathways including fungal biomineralization.",
    ...
    },
    {
        ...
        "source_snippet_a": "The Stefan-Boltzmann law governs thermal radiation emission: Q = εσAT⁴, where emission scales with temperature to the fourth power.",
        "source_snippet_b": "Radiative cooling materials achieve sub-ambient temperatures by maximizing thermal emission through the atmospheric window.",
    ...
    },
    {
        ...
        "source_snippet_a": "Phase change materials absorb and release latent heat during phase transitions, providing thermal regulation.",
        "source_snippet_b": "Infrared stealth camouflage requires dynamic thermal regulation to match background temperature.",
