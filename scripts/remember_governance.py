...
READ_LIST = [
    ...
    ("AEP_PROTOCOL.md", "Autonomous Excellence Protocol. 10 mandatory gates (1-10) + 3 sub-gates (4.5 Consistency, 10.5 Kill-Test, 11 Loop Closure) that every work item must pass before implementation. Gate enforcement: scripts/check_aep_gate.py. Gate artifacts: evidence/gates/. Per CEO AEP-1: 'The system itself should force excellence as the default outcome.'"),
    ("HONESTY_LOOP.md", "the 7th governance layer. Defines the Honesty Loop: READ → SCAN → REPLACE → CLOSE → RE-ENTER. Enforces Law 27 (no numerical certainty without experimental validation), Law 28 (forbidden language), Law 29 (required typed status enums). Adds Gate 11 (Loop Closure) to the AEP. Specifies the 10 priority engines (P1-P10). Scanner: scripts/enforce_law27.py. Per the consolidated review post-BP-2: 'gate score ≠ engineering truth.'"),
]
